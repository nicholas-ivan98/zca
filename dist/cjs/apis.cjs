...
var changeAlias = require('./apis/changeAlias.cjs');
...
var getAlias = require('./apis/getAlias.cjs');
...
class API {
    constructor(ctx, zpwServiceMap, wsUrls) {
        ...
        this.changeAlias = changeAlias.changeAliasFactory(ctx, this);
        ...
        this.getAlias = getAlias.getAliasFactory(ctx, this);
