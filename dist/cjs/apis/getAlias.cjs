...
const aliasCacheUpdater = new WeakMap();
const getAliasFactory = utils.apiFactory()((api, ctx, utils) => {
    var _a, _b;
    const cache = new Map();
...
exports.aliasCacheUpdater = aliasCacheUpdater;
exports.getAliasFactory = getAliasFactory;
